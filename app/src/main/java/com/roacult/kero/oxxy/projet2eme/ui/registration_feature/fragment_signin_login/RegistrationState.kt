...
data class RegistrationState(val viewState : Int ,
                             val signInOperation : Event<Async<MailResult>>?,
                             val logInOperation : Event<Async<None>>?,
                             val confirmatioOperation : Event<Async<None>>?,
                             val resendOperation : Event<Async<None>>?) : State
