...
class ReadableBottomBar @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    /**
     *  i add this function so i can set Selected item
     */
    fun setSelectedItem(position : Int){
        getViewAt(position)?.callOnClick()
    }
    /**
     *i add this function to show help
     */
    /
    fun getViewAt(position : Int) = bottomBarViewItemList.getOrNull(position)
