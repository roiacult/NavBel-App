...
class GetAwards @Inject constructor(dispatchers: CouroutineDispatchers , val repository: MainRepository)  : EitherInteractor<None,List<Award>,Failure.GetAwardsFailure>{
